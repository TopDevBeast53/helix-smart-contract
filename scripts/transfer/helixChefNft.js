 ...
 *     npx hardhat run scripts/transfer/helixChefNft.js --network ropsten
 */
...
const contractName = "HelixChefNFT"

/// The name of the contract in the contracts mapping
const contractAddress = contracts.helixChefNFT[env.network]
