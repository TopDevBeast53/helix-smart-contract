module.exports = {
    auraToken: {
        'main': '',
        'test': '0xAfD66ae7f555bCA74A42A3cE0a1C1b4Fc65C5715',
    },
    auraNFT: {
        'main': '',
    ...
    router: {
        'main': '',
        'test': '0x9029954d5153822E3BD389d6Ef05fA236273f9e4',       // Router currently in use by deployed frontend
    },
    WBNB: {
        'main': '',
    ...
    factory: {
        'main': '',
        'test': '0x9659B39aE48bf37F1dec7A9D2F572801EF13671A',       // Pointed to by router
    },
    oracle: {
        'main': '',
        'test': '0xA6CB8530e35f1FFEBC6B60804815ABba8F1B1C7f',       // Uses window=400 and granularity=2 for successful (and faster) interaction. 
    },
    swapFee: {
        'main': '',
        'test': '0x04561Dc885fFe2Dfc7b39848c12065Ad3B00cc0B',
        // 'test': '0x0236B5666547856FB3d44eacC64137712b4147BE',       // DUMMY CONTRACT FOR TESTING SWAP - DON'T ACTUALLY USE
    },
    testTokenA: {
        'main': '',
    ...
    refReg: {
        'main': '',
        'test': '0xE0d9dDc6C5b06b57dfad7cCE64af8b90B14a21f3',
    }
}
