 ...
 *     npx hardhat run scripts/transfer/helixNftBridge.js --network ropsten
 */
...
const contractName = "HelixNFTBridge"

/// The name of the contract in the contracts mapping
const contractAddress = contracts.helixNFTBridge[env.network]
