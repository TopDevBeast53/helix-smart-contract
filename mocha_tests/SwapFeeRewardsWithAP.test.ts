...
describe('SwapFeeRewardsWithAP', () => {
    ...
    beforeEach(async () => {
        ...
        // Set the factory and oracle.
        let tx = await swapFeeRewardsWithAP.setFactory(factory.address);
        await tx.wait();
    ...
    it('swapFee: sets reward distribution', async () => {
        ...
        await swapFeeRewardsWithAP.setUserDefaultDistribution(newDistribution);
